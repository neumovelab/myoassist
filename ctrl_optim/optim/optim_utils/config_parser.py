...
def load_params_and_create_testenv(
    results_dir: str, filename: str, bat_file_path: str, **override_kwargs
...
def load_exo_4param_kine_config(
    results_dir="results/optim_results/exo_4param",
    filename: str = "example_results.txt",
    config_dir: str = "../training_configs",
) -> Tuple[Any, Dict[str, Any], np.ndarray]:
    """
