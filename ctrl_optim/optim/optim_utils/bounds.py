...
def getBounds_expanded_80mus(control_mode: str) -> List[List[float]]:
    ...
    if control_mode == "2D":
        bound_vect = [
            ...
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 3_HAM_GLU_SG
            [0, np.inf],
            [0, np.inf],  # 4_HFL_C_GLU_PG
            [0, np.inf],
            [0, np.inf],  # 4_HFL_C_HAM_PG
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 4_GLU_C_HFL_PG
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 4_GLU_C_RF_PG
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 4_HAM_GLU_PG
            [0, np.inf],  # 5_TA_PG_st
            [0, np.inf],  # 5_TA_PG_sw
            [0, np.inf],  # 5_TA_SOL_FG
            [0, np.inf],
            ...
            [0, np.inf],  # 5_TOEX_TOFL_FG
            [0, np.inf],
            [0, np.inf],  # 6_HFL_RF_PG
            [0, np.inf],
            [0, np.inf],  # 6_HFL_RF_VG
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 6_GLU_HAM_PG
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],
            [0, np.inf],  # 6_GLU_HAM_VG
            ...
            [0, np.inf],
            [0, np.inf],  # 9_GAS_HAM_SG
            [0, np.inf],
            [0, np.inf],  # 9_GAS_HAM_Thr
            [0, np.inf],
            [0, np.inf],  # 10_HFL_PG
            [0, np.inf],
            [0, np.inf],
