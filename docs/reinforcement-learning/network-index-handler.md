...
> **Note:**  
The order of the observation vector can be checked in the `DEFAULT_OBS_KEYS` of the gym environment.([rl_train/envs/]({{ site.github.repository_url }}/tree/{{ site.repo_branch }}/rl_train/envs/))
