...
class EnvironmentHandler:
    ...
    def get_session_config_from_path(config_path, class_type):
        ...
        config_file_path = os.path.join("myosuite", "rl_train", "myoassist", "train_configs", os.path.basename(config_path))
    ...
    def get_stable_baselines3_model(config, env):
        ...
        if config.env_params.prev_trained_policy_path:
            ...
            from myosuite.rl_train.myoassist.rl_agents.rl_agent_human import HumanActorCriticPolicy
            from myosuite.rl_train.myoassist.rl_agents.rl_agent_exo import HumanExoActorCriticPolicy
